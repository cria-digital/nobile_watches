    ...
    <GuestRoute>
      <div className="min-h-screen relative flex flex-col lg:block bg-[#0A0A0A]">
        ...
        <div className="flex-1 lg:absolute lg:inset-0 relative z-10 flex items-start lg:items-center justify-center lg:px-15 xl:px-15 -mt-[18px] lg:mt-0">
          <div className="w-full lg:max-w-lg rounded-t-[24px] lg:rounded-3xl overflow-hidden">
            <div className="hidden lg:flex h-20 flex-shrink-0 px-[42px] items-center bg-[#EFEFEF]">
              <Image
            ...
            <div className="scrollbar-subtle bg-white w-full lg:max-w-[596px] shadow-2xl px-6 pt-[30px] pb-10 lg:p-10.5 min-h-[69vh] lg:min-h-0 lg:max-h-[90vh] overflow-y-auto">
              {children}
            </div>
          </div>
        </div>
